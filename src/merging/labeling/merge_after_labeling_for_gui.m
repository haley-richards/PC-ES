...
% 
%-------------------------------------------------------------------------------
function [colobj_mrg, tdat_mrg, allscans]= merge_after_labeling_for_gui(scnpth, scnfls, scnpth_raw, scnfls_raw, valpth, valfnm, subj_name)
...
shrt_name=subj_name;
[valtrans, tdat_mrg_filt] = calc_valerr_hr(pgdat,tdat_mrg,colobj_mrg,1, subj_name);
[tdat_mrg_fullset] = find_missing_elec_labels_err(nomdat,pgdat, tdat_mrg_filt,colobj_mrg,0, subj_name);
